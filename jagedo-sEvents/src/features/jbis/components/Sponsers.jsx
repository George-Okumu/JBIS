...
const SponsorsPage = ({setActiveTab}) => {
  ...
  const sponsorshipBenefits = [
    {
      ...
      description:
        "Showcase your brand across multiple touchpoints before, during, and after the event",
    },
    {
      icon: "🤝",
      title: "Quality Networking",
      description:
        "Connect with potential clients, partners, and suppliers in structured environments",
    },
    ...
    },
    {
      ...
      description:
        "Generate high-quality leads through exhibition booths and speaking opportunities",
    },
  ];
          ...
          <div className="max-w-6xl mx-auto py-1">
            <div className="text-center mb-2">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-2">
                Connect with Kenya's construction industry leaders and position your brand at the
            ...
            <div
              className={`transition-all duration-300 overflow-hidden ${
                isSponsorshipExpanded ? "max-h-none opacity-100" : "max-h-0 opacity-0"
              }`}>
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                {sponsorshipBenefits.map((benefit, index) => (
                  <div
                    key={index}
                    className="bg-gray-50 rounded-xl p-6 shadow-sm border border-gray-200 hover:shadow-md transition">
        ...
        <section id="packages" className="py-1 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-6">
              <h2 className="text-3xl font-bold text-gray-900 mb-2">Sponsorship Packages</h2>
            ...
            <div className="grid lg:grid-cols-2 xl:grid-cols-4 gap-8">
              {sponsorshipTiers.map((tier, index) => (
                <div
                  ...
                  {/* Header */}
                  <div
                    className={`bg-gradient-to-r ${tier.color} px-6 py-8 text-center text-white`}>
                  ...
                  {/* CTA Button */}
                  <div onClick={() => setActiveTab('sponsor-reg')} className="p-6 pt-0 mt-auto">
                    <div
                      className={`items-center flex justify-center`}>
                      <Button className="md:w-20 lg:w-38 items-center  h-auto text-white sm:w-56">
                        {" "}
                        Select Package{" "}
                      </Button>
                    </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl p-8 max-w-md w-full">
            ...
            <p className="text-gray-600 mb-6 text-center">
              Thank you for your interest! Our sponsorship team will contact you within 24 hours to
              discuss the {selectedPackage.title} package and answer any questions.
            </p>
