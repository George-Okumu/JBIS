...
const heroSlides = [
  {
    image: Construction1,
    title: "JBIS: JaGedo Builders Innovation Summit (JBIS) 2026",
    subtitle: "Construct the Future",
    description:
          ...
          <article className="bg-white rounded-2xl shadow-lg p-4 md:p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              ...
              <div className="flex flex-col items-center text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200">
                ...
                <p className="text-xl font-bold text-blue-600 mb-1"> 28th - 29th May, 2026</p>
