const HeroSlideshow = ({ slide, image }) => {
  if (!slide) {
    return (
    ...
    <div className="relative w-full h-[300px] lg:h-[400px] xl:h-[700px] overflow-hidden">
      <div className="absolute inset-0 w-full h-full">
        <div
          ...
          <h2 className="text-white text-2xl sm:text-xl md:text-2xl lg:text-3xl font-semibold font-manrope pt-1 sm:pt-2 px-2">
            {slide.subtitle}
          </h2>
          <p className="text-white text-sm sm:text-base md:text-lg max-w-xs sm:max-w-md md:max-w-xl lg:max-w-2xl px-2">
            {slide.description}
          </p>
        </div>
      </div>
